...
public class SnakeConfig {
     ...
     * @param v ширина поля
     */
    public void setFieldWidth(int v) {
        fieldWidth = v;
    }
     ...
     * @param v высота поля
     */
    public void setFieldHeight(int v) {
        fieldHeight = v;
    }
     ...
     */
    public void setFoodCount(int v) {
        foodCount = v;
    }
     ...
     */
    public void setWinLength(int v) {
        winLength = v;
    }
     ...
     */
    public int getInitialSpeedMs() {
        return initialSpeedMs;
    }
     ...
     */
    public void setInitialSpeedMs(int v) {
        initialSpeedMs = v;
    }
     ...
     */
    public void setObstacles(List<ObstacleConfig> v) {
        obstacles = v;
    }
     ...
     */
    public void setBots(List<BotConfig> v) {
        bots = v;
    }
